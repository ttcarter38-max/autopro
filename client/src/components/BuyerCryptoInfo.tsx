  ...
  return (
    <div className="rounded-md border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950 p-4 text-sm">
      <div className="flex items-center gap-2 mb-2 text-blue-900 dark:text-blue-100">
        ...
        <p className="font-semibold">New to crypto? It's easier than you think.</p>
      </div>
      ...
      <ul className="space-y-1.5 text-blue-800 dark:text-blue-200">
        ...
        <li className="flex items-center gap-1.5">
          <ExternalLink className="w-3 h-3 flex-shrink-0" />
          <a href="https://www.cash.app" target="_blank" rel="noopener noreferrer" className="hover:underline font-medium">
            Cash App
          </a>
        ...
        <li className="flex items-center gap-1.5">
          <ExternalLink className="w-3 h-3 flex-shrink-0" />
          <a href="https://www.binance.com" target="_blank" rel="noopener noreferrer" className="hover:underline font-medium">
            Binance
          </a>
          <span className="text-xs opacity-80">— widest selection of coins</span>
        </li>
      </ul>
      <p className="text-xs text-blue-700 dark:text-blue-300 mt-3">
        After your escrow is approved, we'll email you the exact wallet address and
        amount to send. AutoPro is not affiliated with these services.
      </p>
    </div>
  );
}
